...
<html lang="vi">
<head>
    <title>Chỉnh sửa thông tin - Canteen ĐH</title>
...
<main class="min-h-screen">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
            <div>
                <h1 class="text-3xl font-bold text-gray-800">Chỉnh sửa thông tin</h1>
                <p class="text-gray-600 mt-2">Cập nhật họ tên, email, số điện thoại và ảnh đại diện của bạn.</p>
            </div>
            <a href="<%= contextPath %>/customer" class="inline-flex items-center justify-center rounded-md border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50">
                ...
                <div class="lg:flex-1">
                    <form method="post" enctype="multipart/form-data" class="space-y-4">
                        ...
                        <div class="flex justify-end gap-3">
                            <a href="<%= contextPath %>/customer" class="px-4 py-2 rounded-md border border-gray-300 text-gray-700 hover:bg-gray-50">
                                Hủy
                            </a>
